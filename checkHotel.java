...
public class checkHotel extends JFrame implements  Runnable {
    ...
    public void run() {
        ...
        String[] text= new String[]{"JW Marriot Hotel","Mardin Oriental Hotel","Four Seasons Hotel","Raddison Blue Hotel","Classic Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Hotel","River View Hotel"};
        try{
            for(int i=0; i<=9 ;i++){
